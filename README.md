...
$ eksctl create cluster --name khanhnguyendev-cluster \
...
12 ) Add above EKS cluster to ArgoCD with below command
     $ argocd cluster add i-02d69c4f29bdbe7ea@khanhnguyendev-cluster.ap-northeast-1.eksctl.io --name khanhnguyendev-eks-cluster
